...
"""
The iosxr_interface1 config file.
...
class Interface1(ResourceModule):
    """
    The iosxr_interface1 config class
    """
    ...
    def _compare(self, want, have):
        """Leverages the base class `compare()` method and
           ...
           for the Interface1 network resource.
        """
